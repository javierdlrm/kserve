...
properties([
  parameters([
    ...
    choice(name: 'branch', choices: ['', 'release-0.11.2', 'release-0.14.0', 'release-0.14.1', 'release-0.14.1.1', 'release-0.14.1.2', 'release-0.19.0.0'],  description: 'Which branch to build'),
  ])
])
